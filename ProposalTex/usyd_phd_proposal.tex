...
As discussed in section~\ref{sec:synop}, encoder-decoder networks
...
decreasing in training time. However, the question of creating
attention mechanism in input layers still remains open.
